...
--
-- Name: games fkey_teams_opp; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fkey_teams_opp FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);


--
-- Name: games fkey_teams_win; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fkey_teams_win FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);
